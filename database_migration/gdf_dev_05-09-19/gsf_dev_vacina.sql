...
CREATE TABLE `vacina` (
  ...
  KEY `fk_Exame_Consulta1_idx` (`Consulta_ID`),
  CONSTRAINT `fk_Exame_Consulta10` FOREIGN KEY (`Consulta_ID`) REFERENCES `consulta` (`ID`)
...
-- Dump completed on 2019-09-05 22:58:55

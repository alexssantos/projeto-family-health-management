...
<nav class="navbar navbar-brand" id="navbar">
    <a href="#" class="item"><span class="span-mamae"><img id="mamae" src="assets/img/mom.svg" /></span></a>
    ...
    <div class="container max-width-lg cd-timeline__container">
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus1.jpg" alt="Picture">
                        ...
                        <form>
                            <div class="form-row" style="margin-bottom: -15px;">
                                ...
                                <div class="col-md-2 text-center">
                                    <img class="status center" style="width:50%" src="assets/img/status/posterior.jpg" alt="Picture" data-toggle="tooltip" data-placement="top" title="" data-original-title="Concluído">
                                </div>
                            </div>
                        </form>
                    </li>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus2.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 2</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus3.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 3</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus4.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 4</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus5.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 5</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus6.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 6</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus7.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 8</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
        ...
        <div class="cd-timeline__block">
            <div class="cd-timeline__img cd-timeline__img--picture">
                <img src="assets/img/fetus8.jpg" alt="Picture">
            </div> <!-- cd-timeline__img -->
            <div class="cd-timeline__content text-component">
                <h2>Ciclo 8</h2>
                <p class="color-contrast-medium">Parabéns! Você vai ser mamãe! Nessa etapa, o coração do seu bebê já bate.</p>
